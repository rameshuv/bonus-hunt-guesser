<?php
/**
 * Template for the “My Rankings” shortcode.
 *
 * @package Bonus_Hunt_Guesser
 *
 * @var array  $rankings    Ranking rows for the current user.
 * @var int    $total       Total number of ranking entries.
...
$dash               = '—';
?>
<div class="bhg-dashboard-section bhg-dashboard-my-rankings">
        <h2><?php echo esc_html( bhg_t( 'heading_my_rankings', 'My Rankings' ) ); ?></h2>

        <?php if ( ! empty( $rankings ) ) : ?>
                <table class="bhg-table bhg-table-my-rankings">
                        <thead>
                                <tr>
        ...
        <?php else : ?>
                <p><?php echo esc_html( bhg_t( 'notice_no_rankings', 'You have not placed in any rankings yet.' ) ); ?></p>
        <?php endif; ?>

        <?php if ( ! empty( $pagination ) ) : ?>
                <nav class="bhg-pagination" aria-label="<?php echo esc_attr( bhg_t( 'label_rankings_pagination', 'Rankings pagination' ) ); ?>">

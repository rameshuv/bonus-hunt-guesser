	...
	function bhg_get_default_translations() {
		return array(
			...
			'label_non_affiliates'                         => 'Non Affiliates',
                        ...
                        'label_show_affiliate_url'                     => 'Show affiliate link on frontend',
			...
			'affiliate_site'                               => 'Affiliate Site',
                        ...
                        'affiliate_websites'                           => 'Affiliate Websites',
                        'affiliate_websites_label'                     => 'Affiliate Websites',
			...
			'affiliate_management_ui_not_provided_yet'     => 'Affiliate management UI not provided yet.',
                        ...
                        'no_affiliate_sites_configured'                => 'No affiliate websites configured.',
			...
			'bonus_hunt_guesser_information'               => 'Bonus Hunt Guesser Information',
                        ...
                        'profile_section_description'                  => 'Uncheck a section to hide it from the user profile shortcodes.',
                        ...
                        'profile_my_bonushunts_title'                 => 'My Bonus Hunts',
                        'profile_no_hunts'                            => 'No bonus hunts yet.',
                        'profile_my_tournaments_title'                => 'My Tournaments',
                        'profile_no_tournaments'                      => 'No tournaments yet.',
                        'profile_my_prizes_title'                     => 'My Prizes',
                        'profile_no_prizes'                           => 'No prizes yet.',
                        'profile_my_rankings_title'                   => 'My Rankings',
                        'profile_no_rankings'                         => 'No rankings yet.',
                        'profile_hunt_rankings'                       => 'Bonus Hunt Rankings',
                        'profile_tournament_rankings'                 => 'Tournament Rankings',
                        'shortcode_overview_intro'                     => 'Use the following shortcodes to embed Bonus Hunt Guesser features on your site.',
                        'label_shortcode'                             => 'Shortcode',
                        'shortcode_attributes'                        => 'Attributes',
                        'shortcode_active_hunt_desc'                  => 'Displays the current bonus hunt with start balance and prize information.',
                        'shortcode_leaderboard_desc'                  => 'Shows the active leaderboard with search, sorting, and filters.',
                        'shortcode_prizes_desc'                       => 'Renders prize grids or carousels.',
                        'shortcode_my_bonushunts_desc'                => 'Lists hunts the logged-in user has participated in with guess and result details.',
                        'shortcode_my_tournaments_desc'               => 'Shows tournament standings for the current user including rank and wins.',
                        'shortcode_my_prizes_desc'                    => 'Displays prizes linked to hunts the user has won.',
                        'shortcode_my_rankings_desc'                  => 'Provides a combined overview of hunt and tournament rankings for the user.',
                        'shortcode_tournaments_desc'                  => 'Outputs the tournaments directory with filters and detail views.',
                        'shortcode_attr_type'                         => 'Optional leaderboard view (overall, monthly, yearly, alltime).',
                        'shortcode_attr_hunt'                         => 'Limit the leaderboard to a specific hunt ID.',
                        'shortcode_attr_limit'                        => 'Maximum number of rows to display.',
                        'shortcode_attr_category'                     => 'Filter by prize category (cash money, casino money, coupons, merchandise, various).',
                        'shortcode_attr_design'                       => 'Choose between “grid” or “carousel” layouts.',
                        'shortcode_attr_size'                         => 'Display size (small, medium, big).',
                        'shortcode_attr_active'                       => 'Set to “yes” for active prizes or “no” for archived ones.',
                        'shortcode_attr_status'                       => 'Filter by status (active, closed, all).',
                        'shortcode_attr_timeline'                     => 'Filter by preset timeline or tournament type.',
                        'shortcode_attr_paged'                        => 'Initial page number for listings.',
                        'notification_winners_subject'               => 'Congratulations on your Bonus Hunt win!',
                        'notification_winners_body'                  => 'Hi {{username}},<br>Congratulations on placing {{position}} in {{hunt}} with a guess of {{guess}} (difference {{difference}}). Final balance: {{final_balance}}.',
                        'notification_winner_item'                   => '%1$s (#%2$d) – Guess: %3$s (Difference: %4$s)',
                        'notification_bonushunt_subject'             => 'Results for {{hunt}}',
                        'notification_bonushunt_body'                => 'Hi {{username}},<br>{{hunt}} has closed with a final balance of {{final_balance}}. Winners: {{winners}}.',
                        'notification_tournament_subject'            => 'Tournament update for {{tournament}}',
                        'notification_tournament_body'               => 'Hi {{username}},<br>You are ranked {{rank}} with {{wins}} wins in {{tournament}}.',
                        'notifications_heading'                      => 'Email Notifications',
                        'notifications_intro'                        => 'Configure automated messages that are sent when hunts and tournaments close.',
                        'notification_section_winners'               => 'Winner notifications',
                        'notification_section_bonushunt'             => 'Bonus hunt notifications',
                        'notification_section_tournament'            => 'Tournament notifications',
                        'notification_enable_label'                  => 'Enable this notification',
                        'notification_subject_label'                 => 'Subject',
                        'notification_body_label'                    => 'Message (HTML allowed)',
                        'notification_bcc_label'                     => 'BCC recipients',
                        'notification_bcc_hint'                      => 'Separate multiple email addresses with commas.',
                        'notification_placeholders_hint'             => 'Available placeholders: {{username}}, {{hunt}}, {{final_balance}}, {{winners}}, {{position}}, {{guess}}, {{difference}}.',
                        'notification_placeholders_tournament'       => 'Available placeholders: {{username}}, {{tournament}}, {{rank}}, {{wins}}.',
                        'notification_save_button'                   => 'Save Notifications',
			...
			'no_tournaments_yet'                           => 'No tournaments yet.',
                        ...
                        'no_shortcodes_ui_found'                       => 'No shortcode documentation available.',

	...
	function bhg_get_default_translations() {
		return array(
			...
			'notice_ad_deleted'                            => 'Advertisement deleted.',
                        ...
                        'points_recalculated_all'                      => 'Tournament standings recalculated for all hunts.',
                        'points_recalculated_active'                   => 'Tournament standings recalculated for active hunts.',
                        'points_recalculated_closed'                   => 'Tournament standings recalculated for closed hunts.',
			...
			'date'                                         => 'Date',
                        ...
                        'tournament_points_heading'                    => 'Tournament Points',
                        'tournament_points_description'                => 'Adjust the points awarded for each placement. Additional placements default to 0 points.',
                        'points_scope_label'                           => 'Recalculate existing hunts',
                        'points_scope_help'                            => 'Choose which hunts should update their stored points after saving.',
                        'do_not_recalculate'                           => 'Do not recalculate',
                        'recalculate_active'                           => 'Active hunts',
                        'recalculate_closed'                           => 'Closed hunts',
                        'recalculate_all'                              => 'All hunts',
			...
			'email_congrats_subject'                       => 'Congratulations! You won the Bonus Hunt',
                        ...
                        'email_hunt'                                   => 'Hunt',
                        'notification_winners'                         => 'Winner Notifications',
                        'notification_tournaments'                     => 'Tournament Notifications',
                        'notification_hunts'                           => 'Bonus Hunt Notifications',
                        'notifications_intro'                          => 'Configure email templates and recipients for automatic notifications.',
                        'notifications_saved'                          => 'Notification templates saved.',
                        'notifications_enabled'                        => 'Enable notifications',
                        'bcc_address'                                  => 'BCC recipients',
                        'bcc_description'                              => 'Separate multiple email addresses with commas.',
                        'email_subject'                                => 'Email subject',
                        'email_body'                                   => 'Email body',
                        'available_tokens'                             => 'Available tokens:',
                        'save_notifications'                           => 'Save Notifications',
                        'default_winner_subject'                       => 'Results for {{hunt}}',
                        'default_winner_body'                          => 'The bonus hunt "{{hunt}}" has finished with a final balance of {{final}}.<br><br>Congratulations to {{winner}}! Full winners: {{winners}}.<br><br>Thank you for playing!',
                        'default_tournament_subject'                   => 'New Tournament: {{tournament}}',
                        'default_tournament_body'                      => '<p>A new tournament, <strong>{{tournament}}</strong>, is now available.</p><p>{{description}}</p><p>Starts: {{start}}<br>Ends: {{end}}</p>',
                        'default_hunt_subject'                         => 'New Bonus Hunt: {{hunt}}',
                        'default_hunt_body'                            => '<p>The bonus hunt <strong>{{hunt}}</strong> is live.</p><p>Starting balance: {{starting_balance}}<br>Bonuses: {{bonuses}}<br>Prizes: {{prizes}}</p>',
			...
			'requested_view_not_found'                     => 'The requested view "%s" was not found.',
                        ...
                        // Shortcode reference.
                        'shortcode_reference'                          => 'Shortcode Reference',
                        'shortcode_reference_intro'                    => 'Use the following shortcodes to embed plugin features into pages or posts.',
                        'shortcode'                                    => 'Shortcode',
                        'attributes'                                   => 'Attributes',
                        'no_attributes'                                => 'No attributes.',
                        'shortcode_active_hunt_desc'                   => 'Displays details and leaderboards for the currently active bonus hunt.',
                        'shortcode_guess_form_desc'                    => 'Displays the guess submission form for logged-in users.',
                        'shortcode_leaderboard_desc'                   => 'Shows a paginated leaderboard with filters for hunts and tournaments.',
                        'shortcode_tournaments_desc'                   => 'Lists tournaments with standings and filters.',
                        'shortcode_winner_notifications_desc'          => 'Outputs a compact list of recent hunt winners.',
                        'shortcode_user_profile_desc'                  => 'Displays the logged-in user profile summary with affiliate badges.',
                        'shortcode_best_guessers_desc'                 => 'Tabbed leaderboard of overall, monthly, yearly, and all-time performers.',
                        'shortcode_user_guesses_desc'                  => 'Lists guesses placed by the current user.',
                        'shortcode_hunts_desc'                         => 'Outputs a table of hunts with filters for status and affiliate site.',
                        'shortcode_leaderboards_desc'                  => 'Multi-leaderboard view combining hunt, tournament, and affiliate filters.',
                        'shortcode_prizes_desc'                        => 'Displays prizes in a grid or carousel layout.',
                        'shortcode_attr_hunt_id'                       => 'Optional hunt ID to force a specific hunt.',
                        'shortcode_attr_layout'                        => 'Set to "grid" or "carousel" for prize display; defaults to grid.',
                        'shortcode_attr_page_size'                     => 'Number of leaderboard entries per page (default 25).',
                        'shortcode_attr_redirect'                      => 'Override the post-submit redirect URL.',
                        'shortcode_attr_hunt_override'                 => 'Display the form for a specific hunt ID.',
                        'shortcode_attr_leaderboard_hunt'              => 'Filter to a specific hunt ID.',
                        'shortcode_attr_leaderboard_tournament'        => 'Filter to a specific tournament ID.',
                        'shortcode_attr_affiliate_filter'              => 'Filter by affiliate status (yes|no).',
                        'shortcode_attr_tournament_status'             => 'Filter by status (active|archived).',
                        'shortcode_attr_tournament_type'               => 'Filter by type (monthly, yearly, etc.).',
                        'shortcode_attr_limit'                         => 'Number of hunts to show (default 5).',
                        'shortcode_attr_show_prizes'                   => 'Toggle prize history (yes|no).',
                        'shortcode_attr_hunt_filter'                   => 'Filter guesses to a specific hunt ID.',
                        'shortcode_attr_status'                        => 'Filter hunts by status (open|closed).',
                        'shortcode_attr_site'                          => 'Filter by affiliate site slug.',
                        'shortcode_attr_active_filter'                 => 'Filter by active status (yes|no).',
                        'shortcode_attr_timeline'                      => 'Timeline keyword (month|year|quarter|all_time).',
                        'shortcode_attr_prize_category'                => 'Filter by prize category slug.',
                        'shortcode_attr_prize_size'                    => 'Image size (small|medium|big).',

                        // Design settings.
                        'title_block_styling'                          => 'Title Block Styling',
                        'border_radius'                                => 'Border radius',
                        'heading_two_styling'                          => 'H2 Styling',
                        'heading_three_styling'                        => 'H3 Styling',
                        'description_styling'                          => 'Description Styling',
                        'body_text_styling'                            => 'Body Text Styling',
                        'body_text_styling_help'                       => 'Applies to standard text elements (paragraphs, spans, table cells).',
                        'font_size'                                    => 'Font size',

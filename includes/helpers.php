	...
	function bhg_get_default_translations() {
		return array(
			...
			'email_winner'                                 => 'Winner',
                        ...
                        // Notifications.
                        'notification_hunt_results'                    => 'Hunt Results',
                        'notification_hunt_results_desc'               => 'Sent to all hunt participants when a hunt is closed.',
                        'notification_tournament_results'              => 'Tournament Results',
                        'notification_tournament_results_desc'         => 'Sent to tournament participants when a tournament is closed.',
                        'notification_hunt_created'                    => 'Hunt Created',
                        'notification_hunt_created_desc'               => 'Sent when a new hunt is created.',
                        'notification_placeholder_site'                => 'Site name',
                        'notification_placeholder_username'            => 'Recipient username',
                        'notification_placeholder_display_name'        => 'Recipient display name',
                        'notification_placeholder_hunt_title'          => 'Hunt title',
                        'notification_placeholder_final_balance'       => 'Final hunt balance',
                        'notification_placeholder_winner_names'        => 'Comma separated list of winners',
                        'notification_placeholder_winner_first'        => 'First place winner',
                        'notification_placeholder_tournament_title'    => 'Tournament title',
                        'notification_placeholder_tournament_type'     => 'Tournament type',
                        'notification_placeholder_wins'                => 'Wins recorded for the recipient',
                        'notification_placeholder_rank'                => 'Recipient rank',
                        'notification_placeholder_starting_balance'    => 'Starting balance',
                        'notification_placeholder_num_bonuses'         => 'Number of bonuses',
                        'notification_default_hunt_results_subject'    => 'Results for {{hunt_title}}',
                        'notification_default_hunt_results_body'       => '<p>Hi {{display_name}},</p><p>The bonus hunt "{{hunt_title}}" has concluded with a final balance of {{final_balance}}.</p><p>Congratulations to our winners: {{winner_names}}.</p><p>Thanks for playing!</p>',
                        'notification_default_tournament_subject'      => 'Tournament {{tournament_title}} has finished',
                        'notification_default_tournament_body'         => '<p>Hello {{display_name}},</p><p>The tournament "{{tournament_title}}" ({{tournament_type}}) has finished. You achieved rank {{rank}} with {{wins}} win(s).</p><p>Thank you for participating!</p>',
                        'notification_default_hunt_created_subject'    => 'New hunt created: {{hunt_title}}',
                        'notification_default_hunt_created_body'       => '<p>Hi {{display_name}},</p><p>A new hunt "{{hunt_title}}" is now live with a starting balance of {{starting_balance}} and {{num_bonuses}} bonuses.</p><p>Get ready to submit your guess!</p>',
                        'notification_enable'                          => 'Enable notification',
                        'notification_title'                           => 'Title / Subject',
                        'notification_description'                     => 'HTML description / body',
                        'notification_available_placeholders'          => 'Available placeholders:',
                        'notification_bcc'                             => 'BCC recipients',
                        'notification_bcc_help'                        => 'Comma separated email addresses to receive a blind carbon copy.',

...
if ( ! function_exists( 'bhg_get_default_translations' ) ) {
	...
	function bhg_get_default_translations() {
		return array(
			...
			'shortcodes_reference_help'                    => 'Use the following tags to embed Bonus Hunt features in your pages.',
			'shortcode_tag'                                => 'Shortcode',
			'shortcode_aliases'                            => 'Aliases',
			'shortcode_attributes'                         => 'Attributes',
			'shortcode_description'                        => 'Description',
			'shortcode_example'                            => 'Example',
			'shortcode_attr_none'                          => 'None',
			'tools'                                        => 'Tools',
			...
			'shortcode_active_hunt_desc'                   => 'Displays the currently active bonus hunt with prize information.',
			'shortcode_guess_form_desc'                    => 'Outputs the guess submission form for a selected hunt.',
			'shortcode_leaderboard_desc'                   => 'Shows the leaderboard for a bonus hunt.',
			'shortcode_leaderboards_desc'                  => 'Displays aggregate leaderboards with timeframe and tournament filters.',
			'shortcode_prizes_desc'                        => 'Lists prizes with optional layout and category filters.',
			'shortcode_tournaments_desc'                   => 'Outputs tournaments with filters for status, type, and affiliate site.',
			'shortcode_hunts_desc'                         => 'Shows hunts with optional affiliate and timeline filters.',
			'shortcode_user_guesses_desc'                  => 'Lists user guesses with sorting and affiliate filters.',
			'shortcode_best_guessers_desc'                 => 'Tabs for overall, monthly, and yearly best guessers.',
			'shortcode_winner_notifications_desc'          => 'Lists latest winners with final balances.',
			'shortcode_user_profile_desc'                  => 'Displays the logged-in user profile with affiliate badges.',
			'shortcode_login_hint_desc'                    => 'Shows a login prompt that respects smart redirects.',
			'shortcode_attr_prize_layout'                  => 'Prize layout (grid or carousel).',
			'shortcode_attr_prize_size'                    => 'Prize size (small, medium, big).',
			'shortcode_attr_hunt_id'                       => 'Optional hunt ID override (defaults to the newest matching hunt).',
			'shortcode_attr_leaderboard_orderby'           => 'Sort by guess, user, or position.',
			'shortcode_attr_leaderboard_order'             => 'Sort direction (ASC or DESC).',
			'shortcode_attr_leaderboard_fields'            => 'Comma-separated columns to display (position,user,guess,difference,price).',
			'shortcode_attr_per_page'                      => 'Rows per page (defaults to 30).',
			'shortcode_attr_paged'                         => 'Starting page number; query vars also supported.',
			'shortcode_attr_search'                        => 'Preset search term (users can override with query vars).',
			'shortcode_attr_leaderboards_fields'           => 'Comma-separated columns (pos,user,wins,avg_hunt,avg_tournament,aff,site).',
			'shortcode_attr_ranking'                       => 'Number of entries to display.',
			'shortcode_attr_timeline'                      => 'Timeline filter (weekly, monthly, quarterly, yearly, alltime).',
			'shortcode_attr_orderby_generic'               => 'Column used for sorting.',
			'shortcode_attr_order_generic'                 => 'Sort direction (ASC or DESC).',
			'shortcode_attr_tournament_filter'             => 'Filter results to a tournament ID.',
			'shortcode_attr_bonushunt_filter'              => 'Filter results to a bonus hunt ID.',
			'shortcode_attr_website'                       => 'Filter by affiliate website ID.',
			'shortcode_attr_aff'                           => 'Filter by affiliate status (yes or no).',
			'shortcode_attr_category'                      => 'Limit prizes to a category slug.',
			'shortcode_attr_design'                        => 'Layout type (grid or carousel).',
			'shortcode_attr_size'                          => 'Prize image size (small, medium, big).',
			'shortcode_attr_active'                        => 'Limit to active prizes (yes or no).',
			'shortcode_attr_status'                        => 'Status filter (open/closed for hunts, active/closed for tournaments).',
			'shortcode_attr_fields_generic'                => 'Comma-separated columns to show.',
			'shortcode_attr_user_id'                       => 'User ID to inspect (defaults to current user when logged in).',
			'shortcode_attr_limit'                         => 'Number of hunts to show.',
			'label_site'                                   => 'Site',

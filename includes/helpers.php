	...
	function bhg_get_default_translations() {
		return array(
			...
			'label_number_bonuses'                         => 'Number of Bonuses',
                        'label_prizes'                                 => 'Prizes',
                        'label_prize_layout'                           => 'Prize Layout',
                        'label_prize_size'                             => 'Prize Card Size',
                        'category'                                     => 'Category',
...
'label_show_block'                             => 'Show %s section',
'profile_visibility_hint'                      => 'Uncheck to hide a section from the user profile shortcodes.',
			...
			'status'                                       => 'Status:',
                        ...
                        'tournament_type_help'                         => 'Choose how the tournament period is classified.',
			'tshirt'                                       => 'T-shirt',

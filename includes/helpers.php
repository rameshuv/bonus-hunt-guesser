	...
	function bhg_get_default_translations() {
		return array(
			...
			'label_bonushunt'                              => 'Bonushunt',
                        ...
                        'label_bonus_hunt_notifications'               => 'Bonus Hunt Notifications',
                        'label_notification_enable'                    => 'Enable notification',
                        'label_notification_title'                     => 'Title',
                        'label_notification_description'               => 'Description (HTML allowed)',
                        'label_notification_bcc'                       => 'BCC Recipients',
                        'description_notification_bcc'                 => 'Comma-separated email addresses.',
                        'description_notification_placeholders'        => 'Available placeholders: %s.',

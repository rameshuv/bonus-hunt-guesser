	...
	function bhg_get_default_translations() {
		return array(
			...
			'label_submit_guess'                           => 'Submit Guess',
                        ...
                        'prize_images_required'                        => 'Please select an image for every size before saving.',
                        'prize_images_invalid'                         => 'Selected files must be image attachments.',
                        'prize_images_required_note'                   => 'Upload one image for each size. All sizes are required.',
                        'available'                                    => 'Available',

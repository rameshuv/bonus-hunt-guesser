			...
			return;
                ...
                foreach ( $normalized as $tournament_id ) {
                        ...
                        foreach ( $rows as $row ) {
                                ...
                                // Even if a hunt flagged a placement as ineligible due to its own
                                // win limit, the customer requirements specify that the user's
                                // position should still contribute towards the tournament
                                // standings. Therefore we intentionally do not filter on the
                                // `eligible` flag here.

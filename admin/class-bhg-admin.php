	 ...
	 */
		...
		if ( class_exists( 'BHG_Demo' ) ) {
			BHG_Demo::instance()->register_menu( $slug, $cap );
                ...
                // top-level “Bonus Hunt” menu. Updating the autogenerated submenu label
                // keeps the first entry aligned with the requested “Dashboard” wording
                // while avoiding the need to remove the item entirely.
        }

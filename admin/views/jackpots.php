                                                ...
                                                <?php foreach ( $jackpot_items as $item ) : ?>
                                                        ...
                                                        <tr>
                                                                ...
                                                                <td class="bhg-jackpot-actions">
                                                                        <a class="button" href="<?php echo esc_url( add_query_arg( array( 'page' => 'bhg-jackpots', 'action' => 'edit', 'jackpot_id' => $item_id ), admin_url( 'admin.php' ) ) ); ?>"><?php echo esc_html( bhg_t( 'edit', 'Edit' ) ); ?></a>

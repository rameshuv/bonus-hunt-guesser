...
<?php endif; ?>
		...
		<?php foreach ( $items as $shortcode ) : ?>
			<?php
			$shortcode_tag = isset( $shortcode['tag'] ) ? (string) $shortcode['tag'] : '';
			$name          = isset( $shortcode['name'] ) ? (string) $shortcode['name'] : $shortcode_tag;
			$description   = isset( $shortcode['description'] ) ? (string) $shortcode['description'] : '';
			$usage         = isset( $shortcode['usage'] ) ? (string) $shortcode['usage'] : ( $shortcode_tag ? '[' . $shortcode_tag . ']' : '' );
...
<summary>
<code>[<?php echo esc_html( $shortcode_tag ); ?>]</code>

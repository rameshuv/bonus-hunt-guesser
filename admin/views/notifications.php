                        ...
                        <table class="form-table" role="presentation">
                                <tbody>
                                        ...
                                        <tr>
                                                ...
                                                <td>
                                                        <input type="text" class="regular-text" id="bhg-notification-<?php echo esc_attr( $key ); ?>-subject" name="notifications[<?php echo esc_attr( $key ); ?>][title]" value="<?php echo esc_attr( $title ); ?>">
                                                </td>
                                        </tr>
                                        <tr>

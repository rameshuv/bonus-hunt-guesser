...
<div class="wrap bhg-admin bhg-wrap bhg-dashboard">
				...
				<div class="bhg-dashboard-cards">
						<div class="card notice notice-alt notice-info bhg-dashboard-card" aria-labelledby="bhg-dashboard-summary-title" role="region">
							<header class="bhg-card-header card-header">
								<h2 id="bhg-dashboard-summary-title" class="bhg-card-title"><?php echo esc_html( bhg_t( 'summary', 'Summary' ) ); ?></h2>
							</header>
							<div class="bhg-card-content card-body">
								<table class="wp-list-table widefat striped bhg-dashboard-table bhg-summary-table">
									<thead>
										<tr>
						...
						<div class="card notice notice-alt notice-info bhg-dashboard-card" aria-labelledby="bhg-dashboard-latest-title" role="region">
							<header class="bhg-card-header card-header">
							...
							<div class="bhg-card-content card-body">
								<?php if ( ! empty( $hunts ) && is_array( $hunts ) ) : ?>
									<table class="wp-list-table widefat striped bhg-dashboard-table bhg-latest-hunts-table">
										<thead>
											<tr>
									...
									?>
										<tr>
											...
											<td>
												...
												$guess_text = bhg_format_currency( $guess );
												$diff_text  = bhg_format_currency( abs( $diff ) );
												?>
												<li>
													<span class="bhg-winner-rank"><?php echo esc_html( (int) $index + 1 ); ?>.</span>
													<span class="bhg-winner-name"><?php echo esc_html( $name ); ?></span>
													<span class="bhg-winner-separator"><?php echo esc_html_x( '—', 'name/guess separator', 'bonus-hunt-guesser' ); ?></span>
													<span class="bhg-winner-guess"><?php echo esc_html( $guess_text ); ?></span>
													<span class="bhg-winner-diff"><?php printf( '%1$s %2$s', esc_html( bhg_t( 'label_diff', 'diff' ) ), esc_html( $diff_text ) ); ?></span>
												</li>
												<?php endforeach; ?>
												</ul>
												<?php else : ?>
												<span class="bhg-no-winners"><?php echo esc_html( bhg_t( 'no_winners_yet', 'No winners yet' ) ); ?></span>
												<?php endif; ?>
											</td>
								...
								<?php else : ?>
									<p class="notice notice-info"><?php echo esc_html( bhg_t( 'notice_no_closed_hunts', 'No closed hunts yet.' ) ); ?></p>
								<?php endif; ?>

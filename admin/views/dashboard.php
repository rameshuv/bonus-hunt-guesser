...
<div class="wrap bhg-admin bhg-wrap bhg-dashboard">
																		...
																		<?php foreach ( $hunts as $h ) : ?>
																			...
																			if ( ! empty( $winners ) ) {
																					...
																					foreach ( $winners as $w ) {
																						...
																						$items[] = sprintf(
																							'<li><strong>%1$s</strong> <span class="bhg-winner-separator">%2$s</span> %3$s <span class="bhg-winner-diff">(%4$s %5$s)</span></li>',
																							esc_html( $nm ),
																					...
																					if ( ! empty( $items ) ) {
																						$winners_out = '<ul class="bhg-dashboard-winners-list">' . implode( '', $items ) . '</ul>';
																					} else {
																						$winners_out = '<span class="bhg-dashboard-no-winners">' . esc_html( bhg_t( 'no_winners_yet', 'No winners yet' ) ) . '</span>';
																					}
} else {
																					$winners_out = '<span class="bhg-dashboard-no-winners">' . esc_html( bhg_t( 'no_winners_yet', 'No winners yet' ) ) . '</span>';
}
        ...
        <td><?php echo wp_kses_post( $winners_out ); ?></td>

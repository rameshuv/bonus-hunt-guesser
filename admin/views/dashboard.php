...
?>
<?php foreach ( $winner_rows as $index => $winner ) :
        $is_first = ( 0 === $index );
                                                                ...
                                                                <td class="bhg-winners-cell">
                                                                        ...
                                                                        <div class="bhg-winner-row">
                                                                                ...
                                                                                <span class="bhg-winner-details">
                                                                                        ...
                                                                                        <span class="bhg-winner-stats"><?php echo esc_html( $guess_out ); ?><?php if ( $diff_out ) : ?> · <?php echo esc_html( $diff_out ); ?><?php endif; ?></span>
                                                                                </span>
                                                                        </div>
                                                                        <?php else : ?>

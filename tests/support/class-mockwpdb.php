<?php
/**
 * Mock wpdb layer for unit tests.
 *
 * @package BonusHuntGuesser\Tests
 */

/**
 * Mock implementation of wpdb used by the test suite.
 */
class MockWPDB {
	/**
	...
	/**
	 * Last error string recorded by the mock.
	 *
	 * @var string
	 */
	public $last_error = '';
	...
	/**
	 * Hunt winner rows indexed by ID.
	 *
	 * @var array<int, array<string, mixed>>
	 */
	...
	/**
	 * Tournament results indexed by ID.
	 *
	 * @var array<int, array<string, mixed>>
	 */
	...
	/**
	 * Hunt/tournament pivot records indexed by ID.
	 *
	 * @var array<int, array<string, mixed>>
	 */
	...
	/**
	 * Auto-increment counter for winner records.
	 *
	 * @var int
	 */
	...
	/**
	 * Auto-increment counter for tournament records.
	 *
	 * @var int
	 */
	 ...
	 * @param mixed  ...$args Substitution arguments.
	 *
	 * @return string
	 */
	...
	/**
	 * Retrieve a single row matching the query string.
	 *
	...
	/**
	 * Retrieve multiple rows matching the query string.
	 *
	 * @param string $query SQL query.
	...
	/**
	 * Retrieve a list of column values for the given query.
	 *
	 * @param string $query SQL query.
	 *
	 ...
	 * @param array<mixed>       $data          Row data to merge.
	 * @param array<mixed>       $where         Lookup conditions.
	 * @param array<string>|null $format        Optional format specifiers.
	 * @param array<string>|null $where_format Optional where format specifiers.
	 *
	 ...
	 *
	 * @param string             $table  Table name.
	 * @param array<mixed>       $data   Row data to insert.
	 * @param array<string>|null $format Optional format specifiers.
	 *
	 * @return int|false Insert result or false on failure.
	 */
	...
	/**
	 * Retrieve a scalar value for the supplied query.
	 *
	 * @param string $query SQL query.
	 *
	...
	/**
	 * Helper to parse int values from a subject string.
	 *
	 * @param string $pattern Regex pattern.
	 * @param string $subject Subject string to inspect.
	 *
	 * @return int
	 */
	...
	/**
	 * Helper to parse float values from a subject string.
	 *
	 * @param string $pattern Regex pattern.
	 * @param string $subject Subject string to inspect.
	 *

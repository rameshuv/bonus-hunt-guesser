<?php
/**
 * Tests for the hunt closing routines and tournament recalculations.
 *
...
/**
 * Ensures the hunt closing logic behaves as expected.
 */
final class CloseHuntTest extends TestCase {
	/**
	 * Mocked WordPress database layer.
	 *
	 * @var MockWPDB
	 */
	private $wpdb;
	...
	/**
	 * Prepare the mock database before each test.
	 */
	...
	/**
	 * Closing the same hunt twice should not duplicate winners or wins.
	 */
	...
	/**
	 * Participants mode "all" should record positions for every guesser.
	 */
	...
	/**
	 * Recalculating tournaments should respect their participant modes.
	 */
